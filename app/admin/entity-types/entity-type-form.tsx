...
export default function EntityTypeForm() {
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      <Card className="border-[#E6E9F4] bg-white/80" data-tour="entity-basics">
      ...
      <div className="space-y-3" data-tour="entity-fields-list">
        ...
        <div className="space-y-4">
          {fields.map((field, index) => (
            <Card
              key={field.id}
              className="border-[#E6E9F4] bg-white/80"
            ...
            >
              <CardContent className="grid gap-4 p-4 md:grid-cols-6">
                ...
                <div className="space-y-1 md:col-span-1">
                  <Label>Type</Label>
                  <select
                    className="h-10 w-full rounded-xl border border-[#E6E9F4] bg-white/90 px-2 text-sm text-white"
                    value={field.type}
                    onChange={(event) =>
