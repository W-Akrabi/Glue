    ...
    >
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        <div className="space-y-6">
          <Card className="border-[#E6E9F4] bg-white/90" data-tour="org-team">
            <CardHeader>
          ...
          <Card className="border-[#E6E9F4] bg-white/90" data-tour="org-activity">
            <CardHeader>
              ...
              {members.length === 0 ? (
                ...
                <div className="space-y-3">
                  {members.map((member) => (
                    <div
                      key={member.id}
                      className="flex flex-wrap items-center justify-between gap-4 rounded-lg border border-[#E6E9F4] bg-white/80 p-4"
                    >
                      <div>
                      ...
                      <div className="flex flex-wrap items-center gap-6 text-xs text-muted-foreground">
                        <span className="rounded-full border border-[#E6E9F4] px-2 py-1 text-[10px] uppercase tracking-[0.2em] text-gray-400">
                          {member.role}
                        </span>
                        <span>
                          Records created:{' '}
          ...
          <Card className="border-[#E6E9F4] bg-white/90" data-tour="org-billing">
            <CardHeader>
        ...
        <div className="space-y-6">
          <Card className="border-[#E6E9F4] bg-white/90">
            ...
            <CardContent className="space-y-4">
              <div className="rounded-lg border border-[#E6E9F4] bg-white/80 p-4">
